...
public class Inventario {
    ...
    public void agregarProducto(Producto producto) {
        try {
            ...
            while ((linea = raf.readLine()) != null) {
                ...
                // Verificar si el código del producto coincide con el código del producto a
                // agregar
            ...
            if (!encontrado) {
                try (BufferedWriter writer = new BufferedWriter(new FileWriter(rutacsv, true))) {
                    ...
                    writer.write(producto.codigo + "," + producto.cantidadenInv + "," + producto.nombre + ","
                            + producto.getCostoUnitario() + "," + producto.getCostoTotal() + ","
                            + producto.preciounitario + "," + producto.ventas);
    ...
    // metodo para elimnar un producto del inventario usando el identificador del
    // producto
    ...
    public void productosBajosStock() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(rutacsv))) {
            ...
            while ((producto = br.readLine()) != null) {
                ...
                if (cantidad < 5) {
                    System.out.println(
                            "El producto con el codigo " + listTemp[0] + " tiene un stock bajo de: " + listTemp[01]);
